    ...
    <div class="row mb-4">
        <div class="col-md-6">
            ...
            <div class="search-box">
                ...
                <input type="text" class="form-control" id="buscarInteres" placeholder="Buscar interés..." autocomplete="off">
                <button type="button" class="bi bi-x-circle-fill" id="limpiarBuscarInteres" 
