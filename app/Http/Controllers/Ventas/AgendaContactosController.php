...
class AgendaContactosController extends Controller
{
    ...
    public function index(): View
    {
        ...
        foreach ($contactos as $contacto) {
            $cliente = DB::connection('sqlsrvM')
                ...
                ->first(['id_Cliente', 'nombre_completo', 'telefono1', 'correo']);
        ...
        // Opciones de recordatorio desde configuraciones
    ...
    public function edit(int $id): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'nombre_cliente' => $cliente->nombre_completo ?? 'N/A',
    ...
    {
        try {
            // Obtener configuración de minutos de anticipación
    ...
    public function buscarClientes(Request $request): JsonResponse
    {
        ...
        $clientes = DB::connection('sqlsrvM')
            ->table('catalogo_cliente_maestro')
